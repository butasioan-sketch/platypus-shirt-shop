...
const FAQS: FaqItem[] = [
  { q: 'Wie funktioniert das Gestalten meines Shirts?', a: 'Auf der Produktseite lädst du dein Motiv hoch — vorne und hinten auf DIN A4 Hochformat (210×297 mm). Du verschiebst und skalierst es im Editor. Was du siehst, wird so gedruckt — unser Standard ist beidseitiger Druck auf A4.' },
  { q: 'Welche Bildqualität sollte mein Motiv haben?', a: 'Empfohlen: 2480×3508 Pixel (300 dpi, DIN A4 Hochformat). Minimum: 1000 Pixel auf der kürzeren Seite. PNG mit transparentem Hintergrund für scharfe Kanten. Je höher die Auflösung, desto schärfer der Sublimationsdruck.' },
  ...
  { q: 'Wie wird gedruckt?', a: 'Sublimationsdruck auf 100 % Polyester (B&C TM062): Dein Motiv wird auf DIN A4 vertikal gedruckt und per Transferpresse in die Faser eingebrannt — vorne und hinten. Waschbeständig bei 30°C, auf links.' },
