...
const FAQ_DE: FaqItem[] = [
  ...
  { q: 'Aus welchem Material?', a: 'Helles Performance-Polyester (140 g/m²), optimiert für Sublimation. Aktuell in Weiß — weitere Farben folgen.' },
...
const FAQ_RO: FaqItem[] = [
  ...
  { q: 'Din ce material?', a: 'Poliester performance (140 g/m²), optimizat pentru sublimare. Momentan alb.' },
...
const FAQ_EN: FaqItem[] = [
  ...
  { q: 'What material?', a: 'Light performance polyester (140 gsm), sublimation-ready. Currently white only.' },
