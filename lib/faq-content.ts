...
const FAQ_DE: FaqItem[] = [
  ...
  { q: 'Aus welchem Material?', a: 'AirFit Performance Fabric — ein heller Performance-Polyester-Strick (140 g/m²), optimiert für Sublimation. Aktuell in Weiß — weitere Farben folgen.' },
...
const FAQ_RO: FaqItem[] = [
  ...
  { q: 'Din ce material?', a: 'AirFit Performance Fabric — poliester performance (140 g/m²), optimizat pentru sublimare. Momentan alb.' },
...
const FAQ_EN: FaqItem[] = [
  ...
  { q: 'What material?', a: 'AirFit Performance Fabric — a light performance polyester knit (140 gsm), sublimation-ready. Currently white only.' },
